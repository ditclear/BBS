...
<BODY>
	...
	<DIV class="mainbox formbox">
		<s:form name="form1" method="post" action="register"
			...
			<TABLE id="newpost" cellSpacing="0" cellPadding="0" summary="post">
				...
				<TR>
					...
					<td align="left"><input id="username" type="text"
						name="username" value="${request.username}"> <span
						style="color: red;">*</span>用户名长度为6到15之间 <span id="Name"
						style="color: red;">${errors["username"][0]}</span></td>
				...
				<TR>
					...
					<TD align="left"><input type="password" id="password"
						name="password"> <font color="red">*</font>密码长度为6到15之间 <span
						style="color: red;">${errors["password"][0]}</span>
					</TD>
				</TR>
				<TR>
					<Td class="field">确认密码</Td>
					<TD align="left"><input type="password" name="repassword">
						<font color="red">*</font>确认密码长度为6到15之间 <span style="color: red;">${errors["repassword"][0]}</span>
					</TD>
				</TR>
				<TR>
     ...
     <span  style="color: red;">${errors["age"][0]}</span></TD>
				...
				<TR>
					...
					<TD align="left"><input type="text" name="birthDay" /> <span
						style="color: red;">${errors["birthDay"][0]} </span></TD>
				</TR>
				<TR>
					<Td class="field">请选择头像</Td>
					<TD align="left"><s:file name="uploadFile"></s:file> <span
						style="color: red;">${errors["upload"][0]} </span></TD>
				</TR>
				<TR class="buttons">
